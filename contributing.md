...
This project is intended to be a safe, welcoming space for collaboration. All contributors are expected to adhere to the [code of conduct](code-of-conduct.md). Thank you for being kind to each other!
...
1. Contributors should attempt to adhere to the prevailing writing style.
